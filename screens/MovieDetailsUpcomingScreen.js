...
const MovieDetailsUpcomingScreen = props => {
        ...
        >
          ...
          >
            <Image
              ...
              source={{
                uri: 'https://m.media-amazon.com/images/M/MV5BMjQyZTVjZWQtM2VjNC00ZTgwLTk3MzktNzZkM2UxNzkzZjkxXkEyXkFqcGdeQXVyMTEzMTI1Mjk3._V1_FMjpg_UX1000_.jpg',
              }}
              style={StyleSheet.applyWidth(
                StyleSheet.compose(
...
export default withTheme(MovieDetailsUpcomingScreen);
